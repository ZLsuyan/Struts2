...
<body>
	<ol>
		...
		<li>property 设定HTML。escape默认为true,会把<hr/>当字符串输出，
		    escape设定为false,就不会被解析为字符串，而是把它当成正常的html标签，创建一条水平线
		     <s:property value="'<hr/>'" escape="false"/> </li>
		...
		<li>set 设定var,设定完以后，放入了ActionContext里面: <s:set name="adminPassword" value="password" var="a"/></li>
